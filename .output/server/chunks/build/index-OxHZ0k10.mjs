...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(_attrs)}><div class="container-fixed"><div class="grid-row"><div class="col-span-12"><div class="matt"> Hello world </div><section data-debug-inline-utility class="max-w-3xl space-y-6"><span class="inline-flex items-center rounded-full border border-white/10 bg-white/5 px-4 py-1.5 text-sm font-medium text-slate-200"> Nuxt 4 starter </span><h1 class="max-w-2xl text-4xl font-semibold tracking-tight text-white sm:text-6xl">${ssrInterpolate(unref(siteName))}</h1><p class="max-w-2xl text-lg leading-8 text-slate-300">${ssrInterpolate(unref(siteDescription))}</p><div class="flex flex-wrap gap-3">`);
      ...
      _push(ssrRenderComponent(_component_Card, null, {
        title: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`SEO metadata sdfsd`);
          } else {
            return [
              createTextVNode("SEO metadata sdfsd")
            ];
          }
        }),
      ...
      _push(`</section></div></div></div></main>`);
    };
  }
});
...
//# sourceMappingURL=index-OxHZ0k10.mjs.map
